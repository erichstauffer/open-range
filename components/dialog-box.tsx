...
export default function DialogBox({ dialog }: { dialog: DialogState }) {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 p-4 md:p-8 flex justify-center">
      <div
      ...
      >
        <div className="flex items-baseline justify-between mb-2 gap-4">
          ...
          <span className="ui-mono text-[10px] shrink-0" style={{ color: UI.inkSoft }}>
